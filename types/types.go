...
type ImageSource interface {
	...
	// May be "" if unknown.
	IntendedDockerReference(ctx context.Context) string
	...
	GetManifest(ctx context.Context, mimetypes []string) ([]byte, string, error)
	...
	GetLayer(ctx context.Context, digest string) (io.ReadCloser, error)
	// GetSignatures returns the image's signatures.  It may use a remote (= slow) service.
	GetSignatures(ctx context.Context) ([][]byte, error)
}
...
type ImageDestination interface {
	...
	CanonicalDockerReference(ctx context.Context) (string, error)
	...
	PutLayer(ctx context.Context, digest string, stream io.Reader) error
...
type Image interface {
	...
	Layers(ctx context.Context, layers ...string) error // configure download directory? Call it DownloadLayers?
	Inspect(ctx context.Context) (*ImageInspectInfo, error)
	// TODO(runcom): unused?
	//DockerTar(context.Context) ([]byte, error) // ??? also, configure output directory
	...
	GetRepositoryTags(ctx context.Context) ([]string, error)
}
